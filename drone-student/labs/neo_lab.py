...
REAL_MAX_SPEED = 0.6    # m/s mapped to a full normalized command; MUST match mux.yaml max_speed
...
class Launcher:
    ...
    def __init__(self, target_height=DEFAULT_LAUNCH_HEIGHT, climb_kp=1.2, max_climb_speed=2.0,
                 tol=0.25, settle=0.1):
